...
This model may be more favorable than the RNN pointer [model here](https://github.com/cestwc/pointer-generator-model-pytorch) in terms of speed (1 / 6 time on the same dataset) and accuracy (slightly higher). This could be attributed to the advantage of transformer architecture.
